...
export default function PotentialGroupCreate() {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/dashboard/potential-groups');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Kelompok Potensi" />
            <div className="flex flex-col gap-6 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold text-slate-900">Tambah Kelompok Potensi</h1>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 max-w-lg">
                    <form onSubmit={submit} className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <Input id="name" value={data.name} onChange={e => setData('name', e.target.value)} placeholder="cth. Potensi Desa Binaan" />
